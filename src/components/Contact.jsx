  ...
  return (
    <div className="bg-gray-950 text-white">
      ...
      <section className="flex flex-col items-center justify-center px-6 py-20">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-blue-400">Contact Me</h2>
          <p className="text-gray-300 text-base mt-4 leading-relaxed">
            ...
            I can help you with <span className="font-semibold text-blue-400">ML, AI, React, Android, Cloud, and Open Source Development</span>.
          </p>

          {/* Social Icons */}
          <div className="flex gap-6 mt-8 text-3xl">
            <a href={SITE.linkedin} className="hover:text-blue-400 transition"><FaLinkedin /></a>
            <a href={SITE.github} className="hover:text-gray-200 transition"><FaGithub /></a>
          ...
          <a
            href={SITE.resume}
            target="_blank"
            className="mt-10 px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition transform hover:scale-105"
          >
            See My Resume
          </a>
        </motion.div>
      ...
      <section className="flex flex-col items-center justify-center px-6 py-20">
        ...
        >
          ...
          />
          <h2 className="text-3xl md:text-4xl font-semibold mt-6 text-blue-400">Blogs</h2>
          <p className="text-gray-300 text-base mt-4 leading-relaxed">
